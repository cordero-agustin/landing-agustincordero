  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit(finalizarCompra)}>
            <input className='form-control' type="text" name='name' placeholder='Nombre' {...register("name", {required:true, minLength:5})}/>
            ...
            <input className='form-control' type="email" name='email' placeholder='Correo Electrónico' {...register("email", {required:true})}/>
